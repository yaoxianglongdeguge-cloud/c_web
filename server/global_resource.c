...
void Handle_1(Request* r,Response* w)
{
    ...
    Response_header_set(w,"Content-Type","image/jpeg");
}
...
void Handle_3(Request* r,Response* w)
{
    int fd=open("m.html",O_RDONLY);
    Response_fd_set(w,fd,0);
    Response_header_set(w,"Content-Type","text/html");
}
...
int global_resource_init(int Task_Queue_blocknum)
{
    ...
    Handler_append("/yao/xiang/long",Handle_3);
